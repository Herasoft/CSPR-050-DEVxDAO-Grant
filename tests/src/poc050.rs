...
impl Token {
    ...
    pub fn increaseAllowance(&mut self, spender: AccountHash, addedValue: U256, sender: Sender) -> bool {
        self.call(
            sender,
            "mint",
            runtime_args! {
    ...
    pub fn decreaseAllowance(&mut self, spender: AccountHash, subtractedValue: U256, sender: Sender) -> bool {
        self.call(
            sender,
            "mint",
            runtime_args! {
    ...
    pub fn burnFrom(&mut self, account: AccountHash, value: U256, sender: Sender) -> bool {
        self.call(
            sender,
            "burn",
            runtime_args! {
